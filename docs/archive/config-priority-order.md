### <a name="priority-ordering"></a><span data-ttu-id="ae43b-101">Kolejność priorytetów</span><span class="sxs-lookup"><span data-stu-id="ae43b-101">Priority ordering</span></span>
