...
*Dla platformy .NET Core projektów przy użyciu narzędzia NuGet 4.0 +, zobacz [NuGet pakietu i ich przywracania docelowych elementów MSBuild](../schema/msbuild-targets.md) szczegółowe informacje dotyczące różnych elementów docelowych.*
...
Aby uzyskać pełną listę obsługiwanych nazw, zobacz [odwołania docelowych platform](../schema/target-frameworks.md#supported-frameworks).
