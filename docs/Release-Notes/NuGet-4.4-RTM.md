...
---
# <a name="44-rtm-release-notes"></a>4.4 informacje o wersji RTM
...
* Obciążenia lekkie rozwiązanie: Typowe Core PM interfejsu użytkownika, PMC i wektory inicjacji * - [#5057](https://github.com/NuGet/Home/issues/5057)
...
## <a name="link-to-github-issues-fixed-in-44-rtm"></a>Łącze do usunięto w wersji 4.4 RTM zagadnienia GitHub
