...
Od chwili 3.0 RTM również pracujemy nad niektórych podstawowych nowych NuGet funkcji, poza zobaczysz w interfejsie użytkownika. Poniżej przedstawiono krótką listę obszarów inwestycji istotne:
