...
* Dodaj element menu kontekstowego "Aktualizuj" dla zależności pakietów, które uruchamiają interfejs Menedżer pakietów z wstępnie wybranymi pakietami do zaktualizowania — [#10378](https://github.com/NuGet/Home/issues/10378)

    ![Środowisko aktualizacji pakietu klikane prawym przyciskiem myszy](media/releasenotes-59-update.png)

* Wyświetl żądaną wersję (w tym wersję zmienną lub żądanie zakresu wersji) w kolumnie "Wersja" na liście projektów na poziomie rozwiązania Menedżer pakietów interfejsu użytkownika — [#9827](https://github.com/NuGet/Home/issues/9827)

    ![Żądana wersja w interfejsie użytkownika Menedżer pakietów rozwiązania](media/releasenotes-59-requested-version.png)

* Sugestie pakietu IntelliCode na karcie przeglądania interfejsu Menedżer pakietów użytkownika wydanej jako test A/B [—](https://github.com/NuGet/Home/issues/10053) #10053
...
* Pakiet NuGet powinien przechwycić niepoprawne pominięcie kropki w numerach [wersji — #9215](https://github.com/NuGet/Home/issues/9215)

* [CPVM] Wyłącz przypinanie centralnych zależności przechodniej — [#10132](https://github.com/NuGet/Home/issues/10132)
...
* Implementowanie mechanizmu wstępnej rejestracji dla starszych projektów pr pr, które wywołują przywracanie w otwartym [rozwiązaniu — #9986](https://github.com/NuGet/Home/issues/9986)

* Program rekomendacji pakietów NuGet powinien działać po wybraniu więcej niż jednego źródła w menedżerze pakietów [— #10433](https://github.com/NuGet/Home/issues/10433)
...
* INuGetPackageFileService — pobieranie obrazów i licencji osadzonych dla połączonych i autonomicznych usług Codespaces — [#10151](https://github.com/NuGet/Home/issues/10151)

* VS OE: brakujący formatter IProjectMetadataContextInfo — [#10079](https://github.com/NuGet/Home/issues/10079)

* [CPVM-Perf] Zmniejszenie ilości informacji zapisywanych w elementach centralTransitiveDependencyGroups [— #10002](https://github.com/NuGet/Home/issues/10002)

* Operacje przywracania, które są zgłaszane z powodu nieładowania projektu, są zgłaszane jako w telemetrii `NoOp` [— #9985](https://github.com/NuGet/Home/issues/9985)

* Ikony z określonymi paletami kolorów powodują awarię interfejsu użytkownika PM w programie VS — [#10037](https://github.com/NuGet/Home/issues/10037)
...
* Wydajność: zmniejsz liczbę elementów UIDelay w parametrze GetPackageSpecsAsync w przypadku starszych projektów i projektów innych niż projekty #9953 [](https://github.com/NuGet/Home/issues/9953)
...
* Trudne do zobaczenia pole wiersza łącznika formatu pakietu podczas nawigowania po karcie za pomocą okna dialogowego "Wybieranie formatu Menedżer pakietów NuGet" w motywie ciemnym [—](https://github.com/NuGet/Home/issues/9729) #9729
...
* Statyczne przywracanie grafu msbuild — rejestrowanie nieseksarowe dotyczące obiektu MSBuildStartupDirectory — [#10335](https://github.com/NuGet/Home/issues/10335)
...
* Dodawanie telemetrii dla błędów interfejsu API rozszerzalności vs nuGet — [#10062](https://github.com/NuGet/Home/issues/10062)

* Dodaj polecenie GenerateRestoreGraphFile w przywróceniu grafu statycznego, aby zwiększyć możliwości debugowania.  - [#10365](https://github.com/NuGet/Home/issues/10365)
...
* Codespaces: naprawianie danych telemetrycznych z https://github.com/NuGet/NuGet.Client/pull/3786  -  [#10439](https://github.com/NuGet/Home/issues/10439)

* Błąd NU1004 znika podczas tworzenia rozwiązania po włączeniu opcji "RestoreLockedMode" — [#8973](https://github.com/NuGet/Home/issues/8973)

* Klawisz Tabbing za pośrednictwem PMUI w odwrotnym kierunku powinien być dublowany do przodu — [#10234](https://github.com/NuGet/Home/issues/10234)

* Debugowanie pmui w wystąpieniu eksperymentalnym czasami zgłasza wyjątek InvalidCastException z widoku Rozwiązania do widoku ProjectView [— #10416](https://github.com/NuGet/Home/issues/10416)
...
* CreateVersionsAsync robi niepotrzebne porównania NuGetVersion — [#10436](https://github.com/NuGet/Home/issues/10436)
...
* Przestarzała ikona nakłada się na wersję przestarzałego pakietu na karcie Przeglądaj — [#10452](https://github.com/NuGet/Home/issues/10452)
...
* Usuń platformę net45 jako platformę docelową z struktury NuGet.Frameworks — [#10470](https://github.com/NuGet/Home/issues/10470)
...
* Poprawka usługi NuGetPackageFileService — używanie w przypadku strumienia pamięci jednorazowej — [#10503](https://github.com/NuGet/Home/issues/10503)
...
Dziękujemy wszystkim współautorom, którzy pomogli w wytłoceniu tej wersji NuGet!
...
[David z cykadem](https://github.com/PathogenDavid) | [3754](https://github.com/NuGet/NuGet.Client/pull/3754) | Sprawdzanie istnienia pliku licencji i ikony powinno zawsze używać porównania z wielkością liter — [#9817](https://github.com/NuGet/Home/issues/9817)
[campersau](https://github.com/campersau) | [3677](https://github.com/NuGet/NuGet.Client/pull/3677) | Użyj funkcji BitmapCreateOptions.IgnoreColorProfile, aby obejść problem z WPF podczas korzystania z metody DecodePixelWidth — [#10037](https://github.com/NuGet/Home/issues/10037)
[bjorkstromm](https://github.com/bjorkstromm) | [3697](https://github.com/NuGet/NuGet.Client/pull/3697) | Windows SDK 10 jest uszkodzony w przewodniku NuGet.Client Contribution — [#10099](https://github.com/NuGet/Home/issues/10099)
...
[Nirmal4G](https://github.com/Nirmal4G) | [3637](https://github.com/NuGet/NuGet.Client/pull/3637) | Ulepszanie napraw testów i powiązanego kodu [— #9996](https://github.com/NuGet/Home/issues/9996)
