...
## <a name="authentication-issues-with-nuget-feeds-in-vsts-with-nugetexe-v343"></a>Problemy z uwierzytelnianiem ze źródłami danych NuGet w programie VSTS z pakietem NuGet. exe v 3.4.3
