...
W tym przewodniku utworzysz pakietu NuGet natywnego platformy uniwersalnej systemu Windows składnika (w tym formancie XAML) używanego w zarządzanego i natywnego projektów.

1. [Wymagania wstępne](#pre-requisites)
1. [Tworzenie składnika środowiska wykonawczego systemu Windows platformy uniwersalnej systemu Windows](#create-a-uwp-windows-runtime-component)
...
1. 2017 usługi Visual Studio lub Visual Studio 2015. Bezpłatnie zainstalować Community edition z [visualstudio.com](https://www.visualstudio.com/); można także wersje Professional i Enterprise.
...
1. Kliknij prawym przyciskiem myszy *rozwiązania* teraz, wybierz **tworzenia partii**, sprawdź trzy pola debugowania w oknie dialogowym, jak pokazano poniżej. Dzięki temu się upewnić, że po wykonaniu kompilacji zostanie wygenerowany pełny zestaw artefaktów dla poszczególnych systemów docelowych, obsługiwanych przez usługę systemu Windows.

    ![Wsadowe kompilacji](media/UWP-BatchBuild.png)

1. W zadaniu wsadowym Tworzenie okna dialogowego, a następnie kliknij przycisk **kompilacji** Sprawdź projektu i utworzyć pliki wyjściowe, które będą potrzebne dla pakietu NuGet.
...
Spowoduje to wygenerowanie `ImageEnhancer.YOUR_NAME.1.0.0.nupkg`. Otwarcie tego pliku w narzędzia, takiego jak [Explorer pakietu NuGet](https://github.com/NuGetPackageExplorer/NuGetPackageExplorer) i rozszerzanie wszystkich węzłów, zobaczysz następującą zawartość:
...
- [odwołanie .nuspec](../schema/nuspec.md)
