...
----------------------- | -------------------------- | -------- | -----
Autorzy                 | string                     | Brak       |
Utworzone                 | string                     | Brak       | Sygnatura czasowa najpierw utworzenia pakietu. Właściwości rezerwowego: `published`.
...
opis             | string                     | Brak       |
iconUrl                 | string                     | Brak       |
isPrerelease            | wartość logiczna                    | Brak       | Określa, czy wersja pakietu jest w wersji wstępnej. Mogą być wykrywane z `version`.
język                | string                     | Brak       |
